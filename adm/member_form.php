...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td colspan="3" class="td_addr_line">
            <label for="mb_zip" class="sound_only">POSTCODE</label>
            <input type="text" name="mb_zip" value="<?php echo $mb['mb_zip'] ?>" id="mb_zip" class="frm_input readonly" size="4" maxlength="4"><br>
