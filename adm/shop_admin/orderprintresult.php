...
if ($csv == 'csv')
{
    ...
    $sql = " SELECT a.od_id, od_b_zip, od_b_addr1, od_b_addr2, od_b_addr3, od_b_addr_jibeon, od_b_name, od_b_tel, od_b_hp, b.it_name, ct_qty, b.it_id, a.od_id, od_memo, od_invoice, b.ct_option, b.ct_send_cost, b.it_sc_type
    ...
    for ($i=0; $row=mysql_fetch_array($result); $i++)
    {
        ...
        echo '"'.$row['od_b_zip'].'"'.',';
        echo '"'.print_address($row['od_b_addr2'], $row['od_b_addr1'], $row['od_b_addr3'], "").'"'.',';
        echo '"'.$row['od_b_name'].'"'.',';
...
if ($csv == 'xls')
{
    ...
    for($i=1; $row=sql_fetch_array($result); $i++)
    {
        ...
        $worksheet->write($i, 1, print_address($row['od_b_addr2'], $row['od_b_addr1'], $row['od_b_addr3'], ""));
...
<div id="sodr_print_pop" class="new_win">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        // 1.03.02
        $row1['od_addr'] = '('.$row1['od_zip'].') '.print_address($row1['od_addr2'], $row1['od_addr1'], $row1['od_addr3'], "");
        $row1['od_b_addr'] = '('.$row1['od_b_zip'].') '.print_address($row1['od_b_addr2'], $row1['od_b_addr1'], $row1['od_b_addr3'], "");
