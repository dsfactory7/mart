...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>" size="40" maxlength="40">
...
<!--            </th>-->
<!--            <td>-->
<!--                <input type="text" name="mb_zip" value="--><?php //echo $member['mb_zip'] ?><!--" id="reg_mb_zip" --><?php //echo $config['cf_req_addr']?"required":""; ?><!-- class="frm_input --><?php //echo $config['cf_req_addr']?"required":""; ?><!--" size="4" maxlength="4">-->
<!--                <label for="reg_mb_zip">(Postcode)--><?php //echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?><!--</label><br>-->
...
<!--                <label for="reg_mb_addr1">(Street)--><?php //echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?><!--</label><br>-->
...
<!--                <label for="reg_mb_addr2">(Suburb)--><?php //echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?><!--</label><br>-->
<!---->
