...
<!--        --><?php //} ?>
        ...
        <tr>
            ...
            <td>
                ...
                <label for="reg_mb_addr1" class="sound_only">Street<?php echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?></label>
                ...
                <label for="reg_mb_addr2" class="sound_only">Suburb<?php echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?></label>
